...
namespace FrequentPatternMining.DAL.SqlServer
{
    ...
    public sealed class SqlHelper
    {
        ...
        /// <param name="spName">the name of the stored procedures</param>
        /// <param name="colParams">the stored procedures parameters (if needed)</param>
        /// <returns>the prepared slq command</returns>
        ...
        /// Prepare the execution of a stored procedure 
        /// </summary>
        /// <returns>The prepared SqlCommand </returns>
